        ...
        <div className="flex h-[calc(100%-60px)]">
          ...
          <div className="w-64 bg-gradient-to-br from-pink-50 to-yellow-50 border-r-2 border-purple-600 p-4">
            <div className="text-center">
              <div className="w-20 h-20 mx-auto bg-gradient-to-br from-purple-400 to-purple-600 rounded-lg border-2 border-purple-700 flex items-center justify-center text-2xl mb-4 shadow-lg">
              ...
              <div className="bg-white border-2 border-purple-400 p-3 rounded-lg shadow-md">
